...
func NewReviewCourseHandler(reviewPolicySvc *domain.ReviewPolicySvc, uow domain.UnitOfWork) *ReviewCourseHandler {
...
var _ commonhandler.Cmd[ReviewCourse] = (*ReviewCourseHandler)(nil)
