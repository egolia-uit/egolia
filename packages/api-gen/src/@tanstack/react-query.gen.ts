 ...
 */
export const vnpayIpnOptions = (options: Options<VnpayIpnData>) => queryOptions<VnpayIpnResponse, VnpayIpnError, VnpayIpnResponse, ReturnType<typeof vnpayIpnQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
