...
import type { CheckoutCourseResponse, CommentOnPostResponse, CreatePostResponse, GetCertificateByIdResponse, GetCourseDetailResponse, GetCourseLandingPageResponse, GetLessonCommentsResponse, GetMyCertificatesResponse, GetMyCoursesResponse, GetMyEnrolledCoursesResponse, GetPlatformRevenueAnalyticsResponse, GetPostByIdResponse, GetPostCommentsResponse, GetPublishedCoursesResponse, GetSystemCoursesResponse, GetTransactionsResponse, GetUploadVideoLessonUrlResponse, ReplyCommentResponse, SearchCoursesResponse, SearchPostsResponse, UpdateCommentResponse, UpdatePostResponse } from './types.gen';
