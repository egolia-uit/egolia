...
import type { CheckoutCourseResponse, CommentOnPostResponse, CreatePostResponse, GetCertificateByIdResponse, GetCourseDetailResponse, GetCourseResponse, GetInstructorCoursesResponse, GetMyCertificatesResponse, GetMyEnrolledCoursesResponse, GetPlatformRevenueAnalyticsResponse, GetPostByIdResponse, GetPostCommentsResponse, GetPublishedCoursesResponse, GetSystemCoursesResponse, GetTransactionsResponse, GetUploadVideoLessonUrlResponse, ReplyCommentResponse, SearchPostsResponse, UpdateCommentResponse, UpdatePostResponse } from './types.gen';
