...
func (c *courseServiceClient) GetCourseTitlesByIds(ctx context.Context, in *GetCourseTitlesByIdsRequest, opts ...grpc.CallOption) (*GetCourseTitlesByIdsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCourseTitlesByIdsResponse)
	err := c.cc.Invoke(ctx, CourseService_GetCourseTitlesByIds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCourseServiceServer) GetCourseById(context.Context, *GetCourseByIdRequest) (*GetCourseByIdResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCourseById not implemented")
}
...
func _CourseService_GetCourseTitlesByIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCourseTitlesByIdsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CourseServiceServer).GetCourseTitlesByIds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CourseService_GetCourseTitlesByIds_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CourseServiceServer).GetCourseTitlesByIds(ctx, req.(*GetCourseTitlesByIdsRequest))
	}
...
var CourseService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetCourseTitlesByIds",
